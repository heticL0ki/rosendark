...
var game = {
    ...
    init: function(){
        ...
        //"Kindergarten" by Gurdonark - Creative Commons license 
    ...
    showLevelScreen:function(){
        ...
        $('#levelselectscreen').prepend('<p class="level">Choisissez votre niveau de difficulté</p>');
    },
    ...
    /*
	 * TODO : vérifier que la fonctionnalité marche, et modifier sinon.
	 *
     */
    showEndingScreen:function(){
        ...
        if (game.mode==="level-success"){            
            if(game.currentLevel.number<levels.data.length-1){
                $('#endingmessage').html('Félicitations ! Niveau terminé.');
                $("#playnextlevel").show();
            } else {
                $('#endingmessage').html('Bravo, tous les niveaux ont été complétés !');
                $("#playnextlevel").hide();
            }
        } else if (game.mode==="level-failure"){         
            $('#endingmessage').html('Dommage. Retente ta chance !');
            $("#playnextlevel").hide();
        }       
